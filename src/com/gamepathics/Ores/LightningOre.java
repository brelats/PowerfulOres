...
public class LightningOre implements IOre{
	...
	// String
	String oreName = MessageManager.lightningOreName;
	String fragmentName = MessageManager.lightningFragmentName;
	String fragmentLore = MessageManager.lightningFragmentLore;

	// Material
	public static Material oreMaterial = Material.DIAMOND_ORE;
