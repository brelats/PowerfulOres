...
public class FreezeOre implements IOre {

	// String
	String oreName = MessageManager.freezeOreName;
	String fragmentName = MessageManager.freezeFragmentName;
	String fragmentLore = MessageManager.freezeFragmentLore;
