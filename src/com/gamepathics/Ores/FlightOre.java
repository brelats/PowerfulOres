...
public class FlightOre implements IOre {

	// String
	String oreName = MessageManager.flightOreName;
	String fragmentName = MessageManager.flightFragmentName;
	String fragmentLore = MessageManager.flightFragmentLore;

	// Material
	public static Material oreMaterial = Material.COAL_ORE;
