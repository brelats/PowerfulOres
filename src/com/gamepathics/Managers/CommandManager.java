...
public class CommandManager implements CommandExecutor 
{
		...
		if (sender instanceof Player) 
		{
			...
			if (cmd.getName().equalsIgnoreCase(CommandList.mainCommand)) 
			{
				if (args.length > 0) 
				{
					...
					else if(args[0].equalsIgnoreCase(CommandList.oreListCommand)) 
					{
	...
	public boolean giveStick(String[] args, Player player, Player otherPlayer) 
	{
		...
		case CommandList.enderStick:
			...
			player.sendMessage(
					MessageManager.powerfulOresPrefix + o.getStickName() + MessageManager.oreGived + otherPlayer.getName());
			return true;
		...
		case CommandList.freezeStick:
			...
			player.sendMessage(
					MessageManager.powerfulOresPrefix + f.getStickName() + MessageManager.oreGived + otherPlayer.getName());
		...
		case CommandList.flightStick:
			...
			player.sendMessage(
					MessageManager.powerfulOresPrefix + fl.getStickName() + MessageManager.oreGived + otherPlayer.getName());
		...
		case CommandList.fireStick:
			...
			player.sendMessage(
					MessageManager.powerfulOresPrefix + fi.getStickName() + MessageManager.oreGived + otherPlayer.getName());
		...
		case CommandList.lightningStick:
			...
			player.sendMessage(
					MessageManager.powerfulOresPrefix + l.getStickName() + MessageManager.oreGived + otherPlayer.getName());
